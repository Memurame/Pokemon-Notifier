...
$chatID = $update["message"]["chat"]["id"];
    ...
    if ($text == "/start") {
        ...
        $reply = "Du chasch dini Benachrichtigungslischte säuber bearbeite. MIt /add füegsch Pokémeons hinzue und mit /delete löschisch du se us der liste. \n Beispiel: \n/add Glumanda \n Wend mehreri wosch hinzuefüege oder lösche wosch muesch  Pokémons mitemene , trenne.";
        $content = array('chat_id' => $chat_id, 'text' => $reply);
        $telegram->sendMessage($content);
    }
